...
namespace StockScreener.Service.IntegrationTests
{
	public class StockScreenerServiceTestBase
	{
		...
		public virtual void SetUp()
		{
			...
			sut = new StockScreenerService(new SecuritiesGrabber(new StockFinancialsRepository(context), new CompanyInfoRepository(context), new StockIndexRepository(context), new QuarterPriceDataRepository(context)), new FakeLogger());
		}
