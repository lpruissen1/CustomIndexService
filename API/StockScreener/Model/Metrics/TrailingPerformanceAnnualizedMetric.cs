...
{
    public class TrailingPerformanceAnnualizedMetric : RangeAndTimePeriodMetric
    {
        public TrailingPerformanceAnnualizedMetric(List<RangeAndTimePeriod> rangesAndTimeSpans) : base(rangesAndTimeSpans) {}
        ...
        {
            return security.TrailingPerformanceAnnualized;
        }
    }
}
